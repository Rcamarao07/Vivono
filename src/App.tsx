      ...
      <div className="w-full px-4 sm:px-8 lg:px-[4.5rem] relative z-10 text-[#1A2A1A]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-10 lg:gap-20 items-center">
          ...
          <div className="relative group hidden lg:block">
            ...
            >
              <img
                src="/regenerated_image_1777410336650.png"
  ...
  const menuItems = [
    {
      ...
      id: "I",
      image: "/regenerated_image_1777409104906.png",
    },
    {
      title: "Anchova",
      tagline:
      ...
      id: "II",
      image: "/regenerated_image_1777409804354.png",
    },
    {
      title: "Brasiliana",
      tagline:
      ...
      id: "III",
      image: "/regenerated_image_1777409521253.png",
    },
  ];
